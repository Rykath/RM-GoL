...
def compute(frame):
    ...
    frame.details.content.append(tk.Label(frame.details,text='Live Cells: '+str(frame.db[-1].dataNum[0]),bg=config.MDlblCol))
    frame.details.content[-1].grid(row=6,column=0,sticky='nsew',padx=1,pady=1)
    frame.details.content.append(tk.Label(frame.details,text='Bounding Box: '+str(frame.db[-1].countNum[0]),bg=config.MDlblCol))
    frame.details.content[-1].grid(row=6,column=1,sticky='nsew',padx=1,pady=1)
    frame.details.content.append(tk.Label(frame.details,text='Height: '+str(frame.db[-1].heightT),bg=config.MDlblCol))
    frame.details.content[-1].grid(row=7,column=0,sticky='nsew',padx=1,pady=1)
    frame.details.content.append(tk.Label(frame.details,text='Width: '+str(frame.db[-1].widthT),bg=config.MDlblCol))
